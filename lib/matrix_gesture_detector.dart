...
class _MatrixGestureDetectorState extends State<MatrixGestureDetector> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      onScaleEnd: (details) => widget.onDragEnd(),
      child: child,
    );
  }
  ...
  void onScaleUpdate(ScaleUpdateDetails details) {
    widget.onDragStart();  // Why added onScaleUpdate? refer: https://github.com/pskink/matrix_gesture_detector/issues/5#issuecomment-553748004
